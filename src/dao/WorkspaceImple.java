...
import daomain.Workspace;

public class WorkspaceImple implements Workspace {
	@Override
	public String toString() {
		return "WorkspaceImple [worksite=" + worksite + ", pm25=" + pm25 + ", pm10=" + pm10 + ", noise=" + noise
				+ ", domesticelectricity=" + domesticelectricity + ", ofel=" + ofel + ", industrialelectricity="
				+ industrialelectricity + ", domesticwater=" + domesticwater + ", officewater=" + officewater
				+ ", industrialwater=" + industrialwater + ", data=" + data + ", aqi=" + aqi + "]";
	}
	...
	int pm10;
	int noise;
	int domesticelectricity;
	int ofel;
	int industrialelectricity;
	int domesticwater;
	int officewater;
	int industrialwater;
	String data;
	...
	public WorkspaceImple() {
		super();
	}

	public WorkspaceImple(String worksite, int pm25, int pm10, int noise, int domesticelectricity, int ofel,
			int industrialelectricity, int domesticwater, int officewater, int industrialwater, String data, int aqi) {
		super();
